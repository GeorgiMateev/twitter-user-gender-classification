...
tf.flags.DEFINE_string("checkpoint_dir", "runs/1498452502/checkpoints", "Checkpoint directory from training run")
...
if FLAGS.eval_train:
    x_raw, y_test = data_helpers.load_data_labels('train-data/gender-classifier-DFE-791531.csv')
...
if y_test is not None:
    ...
    print(metrics.classification_report(y_test, all_predictions, target_names=['male', 'female', 'brand']))
